<template>
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-form-item>
        <jc-range @statusEvent="handleStatusEvent" > </jc-range>
      </el-form-item>
    ...
    <div class="copyright">
      Copyright © 2020 xxx.com 版权所有 <a href="http://www.example.com/">闽ICP备xxx号</a>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
        ...
        this.$refs.loginForm.validate(valid => {
          if (valid && !this.loading) {
            if(this.verifyStatus){
              ...
              MessageBox.alert('请先向右拖动滑块进行验证！', '错误', {
      ...
      handleStatusEvent (data){
        ...
        //console.log('after-parent-status:'+this.status)
      }
    }
  }
</script>
